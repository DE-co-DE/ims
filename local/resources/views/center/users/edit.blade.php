			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<form action="{!! Asset('center/users/edit/'.$res->id) !!}" method="post" class="form-login">
						...
						<div class="form-group">
						<input type="text"  name="name" id="name" class="form-control" required value="{{$res->person_name}}">
						</div>
						</div>
						...
						<div class="form-group">
						<input type="text"  name="username" id="username" class="form-control" required  value="{{$res->user_name}}">
						</div>
						</div>
						...
						<div class="form-group">
						<input type="text"  name="mobile" id="mobile" class="form-control"   value="{{$res->mobile}}">
						</div>
						</div>
						
						<div class="form-group">

						<label> paswword <span class="symbol required"></span></label>
						<div class="form-group">
						<input type="text"  name="password" required id="password" class="form-control" required  value="{{$res->shw_password}}">
						</div>
						</div>
						...
						<?php if( $res->user_name!='admin'){ ?>

						<div class="form-group">
						<label> Select Permission For This User <span class="symbol required"></span> </label>
						<div class="form-group">
						...
						<?php $array=json_decode($res->perm); ?>
						<?php
						foreach($perms as $perm){
						?>
						<option value="{{$perm->name}}" <?php if(in_array($perm->name,$array))
						{ echo "selected"; } ?>>{{$perm->name}}</option>
						<?php } ?>
						</select>
						</div>
						</div>
