...
Route::get('center/fee/downloadReciept/{pdf}',function($pdf){
	//return \PDF::download(public_path('/pdfs/').$pdf);
	$headers = [
		'Content-Type' => 'application/pdf',
	 ];

return response()->download(public_path('/pdfs/').$pdf, $pdf, $headers);
});
